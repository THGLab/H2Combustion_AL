...
def get_data_subset(data, rxn_num):
    ...
    """
    if not isinstance(rxn_num, str) or (len(rxn_num) != 2 and len(rxn_num) != 3):
        raise ValueError(f"Argument rxn_num {rxn_num} is expected to be a string of length 2 or 3!")
