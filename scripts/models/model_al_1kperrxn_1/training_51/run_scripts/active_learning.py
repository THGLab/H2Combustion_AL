...
import ase.io
from combust.utils import get_spin_for_rxn,run_command,CommandExecuteError
...
def write_and_submit_to_slurm(cmd,name,dirc,prefix):
...
if __name__ =='__main__':
    ...
    uncertain_trajs = glob.glob("geom/uncertain_traj/*_49.traj")
    root = "geom/uncertain_traj"
    npz_path = "geom/new_data/uncertain_traj"
    for traj in uncertain_trajs:
